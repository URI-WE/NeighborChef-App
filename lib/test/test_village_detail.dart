...
Widget testVillageProfileDetail(
  BuildContext context, {
  int postsNumber = 0,
  int memberNumber = 5,
  var villageName = "Neighbor Chef",
  var villageDescript = "Neighbor Chef Developer",
  var date = "10 Nov 2021",
}) {
  var pageName = "Recipe";
  return Scaffold(
        ...
        Container(
          ...
          decoration: BoxDecoration(
              image: new DecorationImage(
                  image: ExactAssetImage('assets/images/villagebanner.jpg'),
                  fit: BoxFit.fill)),
        ),
        Padding(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: new DecorationImage(
                            image: ExactAssetImage(
                                'assets/images/neighborcheflogo.jpg'),
                            fit: BoxFit.fill)),
                  )
                ],
              ),
