...
import 'package:neighborchefapp/test/test_village_detail.dart';

class TestRecommendedVillage extends StatefulWidget {
  const TestRecommendedVillage({Key? key}) : super(key: key);

  @override
  _TestRecommendedVillageState createState() => _TestRecommendedVillageState();
}

class _TestRecommendedVillageState extends State<TestRecommendedVillage> {
  @override
    ...
    return ListView(
      ...
      children: [
        VillageCard(context,
            ...
            recipeImageDetail: testVillageProfileDetail(
              context,
              villageName: villageName[0],
              villageDescript: villageDescript[0],
              date: foundingDate[0],
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                image: new DecorationImage(
                    image:
                        ExactAssetImage('assets/images/neighborcheflogo.jpg'),
                    fit: BoxFit.fill)),
            child: Stack(
              children: <Widget>[
                Positioned(
